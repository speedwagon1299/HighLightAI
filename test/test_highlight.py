...
output_pdf_path = "test_data/test_highlighted.pdf"  # Output path for highlighted PDF
...
def setup_test_environment(tmpdir):
    ...
    dummy_pdf_content = "This is a test PDF.\nIt contains some text for testing highlights."
